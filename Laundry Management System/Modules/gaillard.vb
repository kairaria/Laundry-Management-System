...
Module gaillard
    ...
    Public SelectCustomer, AddCustomer, SelectWorkOrder, AddWorkOrder, EditWorkOrder, SelectWorkOrderItem, AddWorkOrderItem, EditWorkOrderItem, WorkOrderPickup As Boolean
