...
Public Class crRevenueReport
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Laundry_Management_System.crRevenueReport.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedcrRevenueReport
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As crRevenueReport = New crRevenueReport()
        rpt.Site = Me.Site
        Return rpt
    End Function
